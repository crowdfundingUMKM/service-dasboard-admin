import UpdateUserInvestorLayout from '@/pages/user-investor/update-password/layout';
import Link from 'next/link'
import DataTable from '@/components/utils/DataTable';

export default function UpdateUserInvestor() {

    return (

        <UpdateUserInvestorLayout>
            <main id="main" className="main">
                <div className="pagetitle">
                <h1>Update Password User Investor</h1>
                <nav>
                ...
                <div className="row">
                    ...
                    <div className="card">
                        ...
                        <h5 className="card-title">Update Password User Investor</h5>
