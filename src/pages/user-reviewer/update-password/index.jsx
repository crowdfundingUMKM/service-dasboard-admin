import UpdateUserReviewerLayout from '@/pages/user-reviewer/update-password/layout';
import Link from 'next/link';
import DataTable from '@/components/utils/DataTable';

export default function UpdateUserReviewer() {

    return (
        <UpdateUserReviewerLayout>
            <main id="main" className="main">
                <div className="pagetitle">
                <h1>Update Password Konsultan</h1>
                <nav>
                    ...
                    <li className="breadcrumb-item active">
                        Update Password User Konsultan
                    </li>
                    </ol>
                </nav>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="card">
                        ...
                        <h5 className="card-title">Update Password User Konsultan</h5>
