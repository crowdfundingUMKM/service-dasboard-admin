import RegisterLayout from 'src/pages/@auth/register/layout'
                    ...
                    <div className="container">
                        ...
                        <div className="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <Image src="/assets/img/logo.png" alt="" height={100} width={100}/>
                                <span className="d-none d-lg-block">Wellcome Admin</span>
                            </div>
                            </div>
                            {/* End Logo */}
                            ...
                            <div className="card-body">
                                ...
                                <div className="col-12">
                                    ...
                                    Sudah memiliki akun?  <Link href="/@auth/login">Log in</Link>
                                    </p>
                                </div>
                                </form>
                            </div>
