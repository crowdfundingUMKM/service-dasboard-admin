import PreviewCampaignLayout from '@/pages/user-campaign/preview-campaign/layout';
                        ...
                        <div className="row justify-content-center mt-4">
                            ...
                            <div className="card">
                                ...
                                <div className="tab-content pt-2" id="myTabContent">
                                    {/* Tab informasi */}
                                    <div className="tab-pane fade show active" id="pills-informasi" role="tabpanel" aria-labelledby="inforamsi-tab">
                                    <ul>
                                    ...
                                    <div className="link-bisnis m-2">
                                        ...
                                        <i className="bi bi-link"> Link Bisnis</i>
                                        </a>
                                        <a href="#" className="btn btn-primary m-1" role="button">
                                            <i className="ni bi-filetype-pdf"> Proposal Bisnis</i>
                                        </a>
                                    </div>
                                    </div>
                                    {/* Tab Benefit */}
                                    ...
                                    <div className="container">
                                        ...
                                        <div className="col-7">
                                            ...
                                            <a className="btn btn-primary mt-3 m-1" href="#" role="button">
                                                <i className="bi bi-link"> Link Penerbit</i>
                                            </a>
                                            <a className="btn btn-primary mt-3 m-1" href="#" role="button">
                                                <i className="bi bi-whatsapp"> hubungi Penerbit</i>
                                            </a>
                            ...
                            <div className="card">
                                <div className="card-body">
                                <h2 className="card-title">Info Admin</h2>
                                <h5>Active by admin : 324523-32a</h5>
                                <h5>Deactive by admin : -</h5>
                                <h5>Active by reviewer : 324523-32a</h5>
                                <h5>UpdateAt : -</h5>
                                </div>
                            </div>
                            </div>
