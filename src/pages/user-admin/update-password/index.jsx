import UpdatePassAdminLayout from '@/pages/user-admin/update-password/layout';
import Link from 'next/link'
import DataTable from '@/components/utils/DataTable';

export default function UpdatePassAdmin() {

    return (
        <UpdatePassAdminLayout>
            <main id="main" className="main">
                <div className="pagetitle">
                <h1>Update Password User Admin</h1>
                <nav>
                    ...
                    <li className="breadcrumb-item active">Update Password User Admin</li>
                    </ol>
                </nav>
                </div>
                {/* End Page Title */}
                ...
                <div className="row">
                    ...
                    <div className="card">
                        ...
                        <h5 className="card-title">Update Password User Admin</h5>
